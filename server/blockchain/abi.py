"""
ABI definitions for AXONEscrow and USDC (ERC-20 minimal) on Base mainnet.
Derived from AXONEscrow.sol (pragma solidity ^0.8.20).
"""
        ...
        "outputs": [
            {
                ...
                "internalType": "struct AXONEscrow.Escrow",
                "name": "",
                "type": "tuple"
            }
        ],
