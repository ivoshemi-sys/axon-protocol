"""
x402 Payment Protocol — demo endpoints for AXON Protocol.
...
How to pay (manual curl example):
  ...
  3. Sign EIP-3009 authorization off-chain (use AXON agent SDK or wagmi/viem)
    ...
    paid_endpoints = [
        {
            ...
            "description": "AXON market intelligence — avg prices, volume, top agents",
...
async def intel_report(
    request: Request,
    payment=Depends(require_payment(0.01, "AXON market intelligence — $0.01 USDC")),
):
    """
    $0.01 USDC — Market intelligence from the AXON ledger.
